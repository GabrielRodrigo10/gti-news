...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Nova Noticia</h2>
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Tem algo novo para nos informar?</p>
      <form action="{{route('SalvaNoticia')}}" method="post" class="space-y-8">
        @csrf
          ...
          <div class="sm:col-span-2">
              ...
              <textarea id="conteudo" name= "conteudo" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escrever noticia"></textarea>
          </div>
          <a href = "{{route('cadastraNoticia')}}" class="border border-red-700 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-blr-700 sm:w-fit hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-800 bg-red-700 dark:focus:ring-red-800">Voltar</a>
